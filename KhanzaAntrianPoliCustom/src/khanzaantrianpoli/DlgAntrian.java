...
public class DlgAntrian extends javax.swing.JDialog implements ActionListener{    
    ...
    private String poliTerpilih2;
    private String poliTerpilih3;
    private String antri="0",antri2="0",antri3="0",loketPoli1="",loketPoli2="",
            loketPoli3="",nol_detik,detik,namaDokter,namaDokter2,namaDokter3,
            namaPasien,namaPasien2,namaPasien3;
    ...
    private void initComponents() {
        ...
        paneliklan.setBackgroundImage(new javax.swing.ImageIcon(getClass().getResource("/picture/wallpaper.jpg")));
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Antrian Periksa Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(50, 70, 40))); // NOI18N
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), ".: Antrian Pasien 1 :", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(50, 70, 40))); // NOI18N
        ...
        BtnBatal4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/cross.png")));
        BtnBatal4.setMnemonic('8');
        BtnBatal4.setText("Stop");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), ".: Antrian Pasien 2 :", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(50, 70, 40))); // NOI18N
        ...
        BtnBatal5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/cross.png")));
        BtnBatal5.setMnemonic('8');
        BtnBatal5.setText("Stop");
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), ".: Antrian Pasien 3 :", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(50, 70, 40))); // NOI18N
        ...
        BtnBatal6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/cross.png")));
        BtnBatal6.setMnemonic('8');
        BtnBatal6.setText("Stop");
...
private void ppAntri2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppAntri2ActionPerformed
       ...
       if(tabMode2.getRowCount()!=0){
           try {
            ...
            panggi2(Integer.parseInt(tabMode2.getValueAt(0,0).toString()));
...
private void ppAntri3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppAntri3ActionPerformed
       ...
       if(tabMode3.getRowCount()!=0){
           try {
            ...
            try {
                pshapus=koneksi.prepareStatement("delete from antripoli4");
                try {
                    pshapus.executeUpdate();
                } catch (Exception e) {
                    System.out.println("Notif : "+e);
                ...
                pssimpan=koneksi.prepareStatement("insert into antripoli4 values(?,?,?,?)");
                try{
            ...
            panggi3(Integer.parseInt(tabMode3.getValueAt(0,0).toString()));
...
private void BtnAntri1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAntri1ActionPerformed
            ...
            public void windowClosed(WindowEvent e) {
                if(poli.getTable().getSelectedRow()!= -1){
                    if(pilihan==1){
                        ...
                        poliTerpilih = poli.getTable().getValueAt(poli.getTable().getSelectedRow(),1).toString();
                        tampil1();
                        Unit1.requestFocus();
                    }
                        ...
                        poliTerpilih2 = poli.getTable().getValueAt(poli.getTable().getSelectedRow(),1).toString();
                        tampil2();
                        Unit2.requestFocus();
                    }else if(pilihan==3){
                        Unit3.setText(poli.getTable().getValueAt(poli.getTable().getSelectedRow(),1).toString());
                        poliTerpilih3 = poli.getTable().getValueAt(poli.getTable().getSelectedRow(),1).toString();
                        tampil3();
                        Unit3.requestFocus();
                    }  
                }                
    ...
    */
    ...
    private void suaraPoli(String poli){
    ...
    private void panggil(int antrian){
        ...
        String[] poli={"","./suara/poli-syaraf.mp3","./suara/poli-tht.mp3","./suara/poli-penyakit-dalam.mp3","./suara/POLI-ORTOPEDI.mp3",
                       "./suara/poli-bedah-umum.mp3","./suara/POLI-ANAK.mp3","./suara/POLI-GIGI.mp3","./suara/POLI-JANTUNG.mp3","./suara/POLI-KULIT-DAN-KELAMIN.mp3",
                       "./suara/POLI-MATA.mp3","./suara/empat.mp3","./suara/lima.mp3","./suara/enam.mp3","./suara/tujuh.mp3","./suara/delapan.mp3",
                       "./suara/sembilan.mp3","./suara/sepuluh.mp3","./suara/sebelas.mp3"};
        
        if (antrian < 12){
            try {
                System.out.println(poliTerpilih);
                
                BackgroundMusic bm = new BackgroundMusic(urut[antrian]);
                bm.start();
                Thread.sleep(1500);
                bm.stop();
                if("POLIKLINIK SARAF".equals(poliTerpilih)){
                    BackgroundMusic pl = new BackgroundMusic(poli[1]);
                    pl.start();
                    Thread.sleep(1500);
                    pl.stop();
                } else if("POLIKLINIK THT".equals(poliTerpilih)){
                    BackgroundMusic pl = new BackgroundMusic(poli[2]);
                    pl.start();
                    Thread.sleep(1500);
                    pl.stop();
                } else if("POLIKLINIK PENYAKIT DALAM".equals(poliTerpilih)){
                    BackgroundMusic pl = new BackgroundMusic(poli[3]);
                    pl.start();
                    Thread.sleep(1500);
                    pl.stop();
                } else if("POLIKLINIK ORTHOPEDI".equals(poliTerpilih)){
                    BackgroundMusic pl = new BackgroundMusic(poli[4]);
                    pl.start();
                    Thread.sleep(1500);
                    pl.stop();
                } else if("POLIKLINIK BEDAH".equals(poliTerpilih)){
                    BackgroundMusic pl = new BackgroundMusic(poli[5]);
                    pl.start();
                    Thread.sleep(1500);
                    pl.stop();
                } else if("POLIKLINIK ANAK".equals(poliTerpilih)){
                    BackgroundMusic pl = new BackgroundMusic(poli[6]);
                    pl.start();
                    Thread.sleep(1500);
                    pl.stop();
                } else if("POLIKLINIK GIGI DAN MULUT".equals(poliTerpilih)){
                    BackgroundMusic pl = new BackgroundMusic(poli[7]);
                    pl.start();
                    Thread.sleep(1500);
                    pl.stop();
                } else if("POLIKLINIK JANTUNG".equals(poliTerpilih)){
                    BackgroundMusic pl = new BackgroundMusic(poli[8]);
                    pl.start();
                    Thread.sleep(1500);
                    pl.stop();
                } else if("POLIKLINIK KULIT DAN KELAMIN".equals(poliTerpilih)){
                    BackgroundMusic pl = new BackgroundMusic(poli[9]);
                    pl.start();
                    Thread.sleep(2500);
                    pl.stop();
                } else if("POLIKLINIK MATA".equals(poliTerpilih)){
                    BackgroundMusic pl = new BackgroundMusic(poli[10]);
                    pl.start();
                    Thread.sleep(1500);
                    pl.stop();
                }
    ...
    private void panggi2(int antrian){
        String[] urut={"","./suara/satu.mp3","./suara/dua.mp3","./suara/tiga.mp3","./suara/empat.mp3",
                       "./suara/lima.mp3","./suara/enam.mp3","./suara/tujuh.mp3","./suara/delapan.mp3",
                       "./suara/sembilan.mp3","./suara/sepuluh.mp3","./suara/sebelas.mp3"};
        ...
        if (antrian < 12){
            try {
                System.out.println(poliTerpilih2);
                
                BackgroundMusic bm = new BackgroundMusic(urut[antrian]);
                bm.start();
                Thread.sleep(1500);
                bm.stop();
                if("POLIKLINIK SARAF".equals(poliTerpilih2)){
                    BackgroundMusic pl = new BackgroundMusic(poli[1]);
                    pl.start();
                    Thread.sleep(1500);
                    pl.stop();
                } else if("POLIKLINIK THT".equals(poliTerpilih2)){
                    BackgroundMusic pl = new BackgroundMusic(poli[2]);
                    pl.start();
                    Thread.sleep(1500);
                    pl.stop();
                } else if("POLIKLINIK PENYAKIT DALAM".equals(poliTerpilih2)){
                    BackgroundMusic pl = new BackgroundMusic(poli[3]);
                    pl.start();
                    Thread.sleep(1500);
                    pl.stop();
                } else if("POLIKLINIK ORTHOPEDI".equals(poliTerpilih2)){
                    BackgroundMusic pl = new BackgroundMusic(poli[4]);
                    pl.start();
                    Thread.sleep(1500);
                    pl.stop();
                } else if("POLIKLINIK BEDAH".equals(poliTerpilih2)){
                    BackgroundMusic pl = new BackgroundMusic(poli[5]);
                    pl.start();
                    Thread.sleep(1500);
                    pl.stop();
                } else if("POLIKLINIK ANAK".equals(poliTerpilih2)){
                    BackgroundMusic pl = new BackgroundMusic(poli[6]);
                    pl.start();
                    Thread.sleep(1500);
                    pl.stop();
                } else if("POLIKLINIK GIGI DAN MULUT".equals(poliTerpilih2)){
                    BackgroundMusic pl = new BackgroundMusic(poli[7]);
                    pl.start();
                    Thread.sleep(1500);
                    pl.stop();
                } else if("POLIKLINIK JANTUNG".equals(poliTerpilih2)){
                    BackgroundMusic pl = new BackgroundMusic(poli[8]);
                    pl.start();
                    Thread.sleep(1500);
                    pl.stop();
                } else if("POLIKLINIK KULIT DAN KELAMIN".equals(poliTerpilih2)){
                    BackgroundMusic pl = new BackgroundMusic(poli[9]);
                    pl.start();
                    Thread.sleep(2500);
                    pl.stop();
                } else if("POLIKLINIK MATA".equals(poliTerpilih2)){
                    BackgroundMusic pl = new BackgroundMusic(poli[10]);
                    pl.start();
                    Thread.sleep(1500);
                    pl.stop();
    ...
    private void panggi3(int antrian){
        String[] urut={"","./suara/satu.mp3","./suara/dua.mp3","./suara/tiga.mp3","./suara/empat.mp3",
                       "./suara/lima.mp3","./suara/enam.mp3","./suara/tujuh.mp3","./suara/delapan.mp3",
                       "./suara/sembilan.mp3","./suara/sepuluh.mp3","./suara/sebelas.mp3"};
        ...
        if (antrian < 12){
            try {
                System.out.println(poliTerpilih3);
                
                BackgroundMusic bm = new BackgroundMusic(urut[antrian]);
                bm.start();
                Thread.sleep(1500);
                bm.stop();
                if("POLIKLINIK SARAF".equals(poliTerpilih3)){
                    BackgroundMusic pl = new BackgroundMusic(poli[1]);
                    pl.start();
                    Thread.sleep(1500);
                    pl.stop();
                } else if("POLIKLINIK THT".equals(poliTerpilih3)){
                    BackgroundMusic pl = new BackgroundMusic(poli[2]);
                    pl.start();
                    Thread.sleep(1500);
                    pl.stop();
                } else if("POLIKLINIK PENYAKIT DALAM".equals(poliTerpilih3)){
                    BackgroundMusic pl = new BackgroundMusic(poli[3]);
                    pl.start();
                    Thread.sleep(1500);
                    pl.stop();
                } else if("POLIKLINIK ORTHOPEDI".equals(poliTerpilih3)){
                    BackgroundMusic pl = new BackgroundMusic(poli[4]);
                    pl.start();
                    Thread.sleep(1500);
                    pl.stop();
                } else if("POLIKLINIK BEDAH".equals(poliTerpilih3)){
                    BackgroundMusic pl = new BackgroundMusic(poli[5]);
                    pl.start();
                    Thread.sleep(1500);
                    pl.stop();
                } else if("POLIKLINIK ANAK".equals(poliTerpilih3)){
                    BackgroundMusic pl = new BackgroundMusic(poli[6]);
                    pl.start();
                    Thread.sleep(1500);
                    pl.stop();
                } else if("POLIKLINIK GIGI DAN MULUT".equals(poliTerpilih3)){
                    BackgroundMusic pl = new BackgroundMusic(poli[7]);
                    pl.start();
                    Thread.sleep(1500);
                    pl.stop();
                } else if("POLIKLINIK JANTUNG".equals(poliTerpilih3)){
                    BackgroundMusic pl = new BackgroundMusic(poli[8]);
                    pl.start();
                    Thread.sleep(1500);
                    pl.stop();
                } else if("POLIKLINIK KULIT DAN KELAMIN".equals(poliTerpilih3)){
                    BackgroundMusic pl = new BackgroundMusic(poli[9]);
                    pl.start();
                    Thread.sleep(2500);
                    pl.stop();
                } else if("POLIKLINIK MATA".equals(poliTerpilih3)){
                    BackgroundMusic pl = new BackgroundMusic(poli[10]);
                    pl.start();
                    Thread.sleep(1500);
                    pl.stop();
    ...
    private void jam1(){
        ActionListener taskPerformer = new ActionListener(){
            public void actionPerformed(ActionEvent e) {
                ...
                if(detik.equals("05")||detik.equals("15")||detik.equals("25")||detik.equals("35")||detik.equals("45")||detik.equals("55")){                    
                    antri="";
                    loketPoli1="";
                    namaDokter="";
                    namaPasien="";
                    try {
                        pscari=koneksi.prepareStatement("select antrian,poli,nama_pasien,nama_dokter from antripoli2");
                        try {
                            rs=pscari.executeQuery();
                            if(rs.next()){
                                antri=rs.getString("antrian");
                                loketPoli1=rs.getString("poli");
                     ...
                     if(!antri.equals("")){
                         labeldokter1.setText(namaDokter);
                         labelantri1.setText(antri);
                         labelpas1.setText(namaPasien);
                         poliTerpilih=loketPoli1;
                         form1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(100, 200, 100)), loketPoli1+" :", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("SansSerif", 0, 36), new java.awt.Color(100, 150, 100)));
                            try {
        ...
        ActionListener taskPerformer = new ActionListener(){
            public void actionPerformed(ActionEvent e) {
                ...
                if(detik.equals("05")||detik.equals("15")||detik.equals("25")||detik.equals("35")||detik.equals("45")||detik.equals("55")){                    
                    ...
                    namaPasien2="";
                    try {
                        pscari=koneksi.prepareStatement("select antrian,poli,nama_pasien,nama_dokter from antripoli3");
                        try {
                            rs=pscari.executeQuery();
                            if(rs.next()){
                                antri2=rs.getString("antrian");
                                loketPoli2=rs.getString("poli");
                                namaDokter2=rs.getString("nama_dokter");
                                namaPasien2=rs.getNString("nama_pasien");
                            }
                        } catch (Exception z) {
                            System.out.println("Notif : "+z);
                        } finally{
                     ...
                     if(!antri2.equals("")){
                         labeldokter2.setText(namaDokter2);
                         labelantri2.setText(antri2);
                         labelpas2.setText(namaPasien2);
                         poliTerpilih2=loketPoli2;
                         form2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(100, 200, 100)), loketPoli2+" :", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("SansSerif", 0, 36), new java.awt.Color(100, 150, 100)));
                            try {
                                music=new BackgroundMusic("./suara/nomor-urut.mp3");
                                music.start();
                                Thread.sleep(1500);
                                panggi2(Integer.parseInt(antri2));                     
                            } catch (InterruptedException ex) {
                               System.out.println(e);
                            }                               
                    }
        ...
        ActionListener taskPerformer = new ActionListener(){
            public void actionPerformed(ActionEvent e) {
                ...
                if(detik.equals("05")||detik.equals("15")||detik.equals("25")||detik.equals("35")||detik.equals("45")||detik.equals("55")){                    
                    ...
                    namaPasien3="";
                    try {
                        pscari=koneksi.prepareStatement("select antrian,poli,nama_pasien,nama_dokter from antripoli4");
                        try {
                            rs=pscari.executeQuery();
                            if(rs.next()){
                                antri3=rs.getString("antrian");
                                loketPoli3=rs.getString("poli");
                                namaDokter3=rs.getString("nama_dokter");
                                namaPasien3=rs.getString("nama_pasien");
                            }
                        } catch (Exception z) {
                            System.out.println("Notif : "+z);
                        } finally{
                     ...
                     if(!antri3.equals("")){
                         labeldokter3.setText(namaDokter3);
                         labelantri3.setText(antri3);
                         labelpas3.setText(namaPasien3);
                         poliTerpilih3=loketPoli3;
                         form3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(100, 200, 100)), loketPoli3+" :", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("SansSerif", 0, 36), new java.awt.Color(100, 150, 100)));
                            try {
                                music=new BackgroundMusic("./suara/nomor-urut.mp3");
                                music.start();
                                Thread.sleep(1500);
                                panggi3(Integer.parseInt(antri3));                    
                            } catch (InterruptedException ex) {
                               System.out.println(e);
                            }                               
                    }
