...
public class DlgAntrian extends javax.swing.JDialog implements ActionListener{    
    ...
    private void initComponents() {
        ...
        labelLoket.setText("Apotek");
        labelLoket.setFocusable(false);
        labelLoket.setFont(new java.awt.Font("Tahoma", 1, 100));
        ...
        cmbloket.setModel(new javax.swing.DefaultComboBoxModel(new String[] {"Apotek"}));
        cmbloket.setName("cmbloket"); // NOI18N
        panelisi5.add(cmbloket);
        cmbloket.setBounds(65, 12, 80, 23);
