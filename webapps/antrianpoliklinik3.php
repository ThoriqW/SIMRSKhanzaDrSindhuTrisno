...
<body class="bg">
                ...
                <ul class="center hide-on-med-and-down" id="nv">
                    <li>
                        <a href="./" class="ams hide-on-med-and-down"><i
                                class="material-icons md-36">local_hospital</i>Antrian Poliklinik 3</a>
                    </li>
    ...
    <script type="text/javascript">
        var auto_refresh = setInterval(
            function () {
                $('#data').load('data_antrianpoliklinik3.php').fadeIn("fast");
            }, 9000
        );
        var auto_refresh = setInterval(
            function () {
                $('#judul').load('data_antrianpoliklinikjudul3.php').fadeIn("fast");
            }, 2000
        );
        $('#judul').load('data_antrianpoliklinikjudul3.php').fadeIn("fast");
        $('#data').load('data_antrianpoliklinik3.php').fadeIn("fast");
