...
<head>
    <title>Antrian Poliklinik 1</title>
...
<body class="bg">
                ...
                <ul class="center hide-on-med-and-down" id="nv">
                    <li>
                        <a href="./" class="ams hide-on-med-and-down"><i
                                class="material-icons md-36">local_hospital</i>Antrian Poliklinik 1</a>
                    </li>
    ...
    <script type="text/javascript">
        ...
        function callPasien(nomor, poli) {
            if (poli == "POLIKLINIK SARAF") {
                var poliSound = new Audio('suara/saraf.mp3');
                var nomorurut;
                for (var i = 1; i <= 50; i++) {
                    if (parseInt(nomor) === i) {
            ...
            if (poli == "POLIKLINIK BEDAH") {
                var poliSound = new Audio('suara/bedah.mp3');
                var nomorurut;
                for (var i = 1; i <= 50; i++) {
                    if (parseInt(nomor) === i) {
                        nomorurut = new Audio('suara/' + i + '.mp3');
            ...
            if (poli == "POLIKLINIK GIGI DAN MULUT") {
            ...
            if (poli == "POLIKLINIK THT") {
                var poliSound = new Audio('suara/tht.mp3');
                var nomorurut;
                for (var i = 1; i <= 50; i++) {
                    if (parseInt(nomor) === i) {
                        nomorurut = new Audio('suara/' + i + '.mp3');
    ...
    <script type="text/javascript">
        ...
        var auto_refresh = setInterval(
            function () {
                $('#judul').load('data_antrianpoliklinikjudul1.php').fadeIn("fast");
            }, 2000
        );
        $('#judul').load('data_antrianpoliklinikjudul1.php').fadeIn("fast");
        $('#data').load('data_antrianpoliklinik1.php').fadeIn("fast");
