...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnAllergyIntoleranceActionPerformed(java.awt.event.ActionEvent evt) {
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
    ...
    */
    ...
    private widget.Button BtnSkorBromagePascaAnestesi,BtnPenilaianPreInduksi,BtnHasilPemeriksaanUSGUrologi,BtnHasilPemeriksaanUSGGynecologi,BtnHasilPemeriksaanEKG,BtnPenatalaksanaanTerapiOkupasi,BtnPenilaianPsikolog,
                          ...
                          BtnSkriningKesehatanGigiMulutremaja,BtnSkriningTBC,BtnAllergyIntoleran;    
    ...
    public void isCek(){
        ...
        if(akses.getsatu_sehat_kirim_allergy_intollerance()==true){
            tinggi=tinggi+24;
        }
    ...
    private void initRawatJalan(){
        ...
        BtnAllergyIntoleran = new widget.Button();
        BtnAllergyIntoleran.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); 
        BtnAllergyIntoleran.setText("Alergi Intoleran");
        BtnAllergyIntoleran.setFocusPainted(false);
        BtnAllergyIntoleran.setFont(new java.awt.Font("Tahoma", 0, 11)); 
        BtnAllergyIntoleran.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAllergyIntoleran.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAllergyIntoleran.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAllergyIntoleran.setName("BtnAllergyIntoleran"); 
        BtnAllergyIntoleran.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnAllergyIntoleran.setRoundRect(false);
        BtnAllergyIntoleran.addActionListener(this::BtnAllergyIntoleranceActionPerformed);
        ...
        FormMenu.add(BtnAllergyIntoleran);
    }
