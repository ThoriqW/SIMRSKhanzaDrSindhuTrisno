...
public final class DlgKasirRalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TglSakit1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-12-2023" }));
        ...
        TglSakit2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-12-2023" }));
    ...
    private void ppMasukPoliBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppMasukPoliBtnPrintActionPerformed
        if(tabModekasir.getRowCount()==0){
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                ...
                try {
                    if("U0010".equals(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),18).toString())){
                        BackgroundMusic pl = new BackgroundMusic(poli[7]);
                        pl.start();
                        Thread.sleep(1500);
                        pl.stop();
                    } else if("Poliklinik THT".equals("")){
