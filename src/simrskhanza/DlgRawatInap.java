...
public final class DlgRawatInap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnAlergiIntoleran = new widget.Button();
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-04-2024" }));
        ...
        BtnAlergiIntoleran.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAlergiIntoleran.setText("Alergi Inteloran");
        BtnAlergiIntoleran.setFocusPainted(false);
        BtnAlergiIntoleran.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAlergiIntoleran.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAlergiIntoleran.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAlergiIntoleran.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAlergiIntoleran.setName("BtnAlergiIntoleran"); // NOI18N
        BtnAlergiIntoleran.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnAlergiIntoleran.setRoundRect(false);
        BtnAlergiIntoleran.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAlergiIntoleranActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAlergiIntoleran);
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    */
    ...
    private widget.Button BtnAlergiIntoleran;
