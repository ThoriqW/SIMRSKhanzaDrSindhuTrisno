 ...
 * @author perpustakaan
 */
public class DlgViewPdfOld extends javax.swing.JDialog {
    private Connection koneksi=koneksiDB.condb();
    private sekuel Sequel=new sekuel();
    private String username="",alasanHapus,fileOpen="",LocationFile="",tipeBerkas="";
     ...
     * @param parent
     * @param modal */
    public DlgViewPdfOld(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgViewPdfOld dialog = new DlgViewPdfOld(new javax.swing.JFrame(), true);
...
public void tampilPdfLocal(String namFile,String Location,String pathFile,String NoRawat,String kodFile)
{
    txtNameFile.setText(namFile);
    txtLokasiFile.setText(pathFile);
