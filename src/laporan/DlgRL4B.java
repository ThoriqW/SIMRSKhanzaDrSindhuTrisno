                    ...
                    "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                        "<tr class='isi2'>"+
                            "<td valign='top' align='center'>"+
                                ...
                                "<font size='2' face='Tahoma'>DATA KEADAAN MORBIDITAS PASIEN RAWAT JALAN RUMAH SAKIT PENYEBAB KECELAKAAN<br>PERIODE "+Tgl1.getSelectedItem()+" s.d. "+Tgl2.getSelectedItem()+"<br><br></font>"+        
                            "</td>"+
                       "</tr>"+
                    "</table>")
            );
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    ps4=koneksi.prepareStatement(
                            "select diagnosa_pasien.kd_penyakit,reg_periksa.umurdaftar,reg_periksa.sttsumur,pasien.jk,pasien_tni.golongan_tni,golongan_tni.nama_golongan from diagnosa_pasien "+
                            "inner join reg_periksa on reg_periksa.no_rawat=diagnosa_pasien.no_rawat "+
                            "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                            "inner join dokter on reg_periksa.kd_dokter=dokter.kd_dokter "+
                            "inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli "+
                            ...
                            "inner join kecamatan on pasien.kd_kec=kecamatan.kd_kec "+
                            "inner join kelurahan on pasien.kd_kel=kelurahan.kd_kel "+
                            "inner join pasien_tni on reg_periksa.no_rkm_medis=pasien_tni.no_rkm_medis "+
                    ...
                    try {
                        if(nmpoli.getText().trim().equals("")&&nmdokter.getText().trim().equals("")&&nmpenjab.getText().trim().equals("")&&nmkabupaten.getText().trim().equals("")&&nmkecamatan.getText().trim().equals("")&&nmkelurahan.getText().trim().equals("")){
                            ...
                            ps4.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                            ps4.setString(3,rs.getString("kd_penyakit"));
                            ps4.setString(4,"%"+nmpoli.getText().trim()+"%");
                            ps4.setString(5,"%"+nmdokter.getText().trim()+"%");
                            ps4.setString(6,"%"+nmpenjab.getText().trim()+"%");
                            ps4.setString(7,"%"+nmkabupaten.getText().trim()+"%");
                            ps4.setString(8,"%"+nmkecamatan.getText().trim()+"%");
                            ps4.setString(9,"%"+nmkelurahan.getText().trim()+"%");
                        }
