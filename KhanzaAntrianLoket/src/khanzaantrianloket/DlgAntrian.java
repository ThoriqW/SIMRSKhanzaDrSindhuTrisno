...
public class DlgAntrian extends javax.swing.JDialog implements ActionListener{    
    ...
    private void initComponents() {
        ...
        cmbloket.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "1", "2", "3", "4", "5", "6", "7", "8", "9", "Pendaftaran" }));
        cmbloket.setName("cmbloket"); // NOI18N
        cmbloket.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbloketActionPerformed(evt);
            }
        });
        panelisi5.add(cmbloket);
        cmbloket.setBounds(65, 12, 90, 23);
                    ...
                    if(!antri.equals("")){
                        ...
                        if(prop.getProperty("ANTRIAN").equals("player")){
                            try {
                                ...
                                if("Pendaftaran".equals(loket)){
                                    music=new BackgroundMusic("./suara/pendaftaran.mp3");
                                    music.start();
                                    Thread.sleep(1500);
                                } else {
